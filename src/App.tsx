      ...
      <Route path="*" element={
        <ProtectedRoute>
          <div className="flex flex-col h-screen overflow-hidden">
            <header className="flex shrink-0 h-14 items-center justify-between gap-4 px-4 py-3 border-b border-[var(--border)] bg-[var(--bg-secondary)]">
              <button
                type="button"
            ...
            <div className="flex flex-1 overflow-hidden relative">
              <div
                ...
                aria-hidden="true"
              />
              <aside className={`fixed md:relative top-14 bottom-0 md:top-auto md:bottom-auto left-0 md:left-auto z-50 md:z-auto w-64 min-w-64 md:h-full flex-shrink-0 transform transition-transform duration-200 ease-out md:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}>
                <Sidebar onNavigate={() => setSidebarOpen(false)} />
              </aside>
              <main className="flex-1 overflow-hidden flex flex-col bg-[var(--bg-primary)] min-w-0">
