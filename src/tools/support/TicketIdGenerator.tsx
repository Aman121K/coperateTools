...
export function TicketIdGenerator() {
  ...
  return (
    <ToolLayout title="Ticket ID Generator" description="Generate support ticket IDs. Purpose: Create unique ticket references for tracking support requests and follow-ups." input="" output={output} onInputChange={() => {}} toolId="ticket-id" singlePanel showCopyMinified={false}>
