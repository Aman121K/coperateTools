...
export const TOOLS: Tool[] = [
  ...
  { id: 'remove-bg', name: 'Remove Background', department: 'developer', category: 'media', path: '/tools/media/remove-bg', icon: '✂' },
  { id: 'make-color-transparent', name: 'Make Color Transparent', department: 'developer', category: 'media', path: '/tools/media/make-transparent', icon: '🎨' },
  { id: 'replace-bg', name: 'Replace Background', department: 'developer', category: 'media', path: '/tools/media/replace-bg', icon: '🖼' },
