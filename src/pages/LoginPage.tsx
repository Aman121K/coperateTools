          ...
          <div className="w-full max-w-md rounded-2xl border border-[var(--border)] bg-[var(--bg-secondary)] p-6 sm:p-8 shadow-[var(--shadow-card)]">
            <div className="flex flex-col items-center mb-6">
              ...
              <p className="text-sm text-[var(--text-muted)] text-center mt-2">
                Secure access to internal productivity tools
              </p>
            </div>
            ...
            <div className="space-y-3">
              {isFirebaseConfigured ? (
                <>
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl bg-[var(--bg-tertiary)] hover:bg-[var(--bg-elevated)] text-[var(--text-primary)] border border-[var(--border)] font-medium transition-colors"
                  >
                    <svg className="w-5 h-5 shrink-0" fill="currentColor" viewBox="0 0 24 24">
              ...
              <button
                type="button"
                onClick={signInDemo}
                className="w-full flex items-center justify-center gap-3 px-4 py-3.5 rounded-xl bg-[var(--accent)] hover:bg-[var(--accent-hover)] text-white font-semibold transition-all hover:scale-[1.01] active:scale-[0.99]"
              >
                {isFirebaseConfigured ? 'Continue as Guest' : 'Explore as Guest'}
              </button>
            </div>

            <p className="mt-6 text-center text-xs text-[var(--text-muted)]">
              Enterprise-ready • No credit card • Private by design
            </p>
            ...
            {!isFirebaseConfigured && (
              <p className="mt-4 text-xs text-[var(--text-muted)] text-center">
                Add Firebase config to `.env` for Google/Facebook/GitHub login.
              </p>
            )}
          </div>
        </section>
